                ...
                <div className="flex text-center justify-center items-center gap-4 flex-col">
                    ...
                    <div className="grid text-left w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 divide-x pt-20 space-y-24 sm:space-y-12 lg:gap-0">
                        ...
                        <div className="grid grid-rows-12 px-3 py-1 md:px-6 md:py-4 gap-2 max-h-64">
                            ...
                            <Button variant="outline" className="row-span-2 gap-4 mt-8" onClick={() => router.push("https://iotapp.salkaro.com/sign-up")}>
                                Get started
                            </Button>
                        </div>
                        ...
                        <div className="grid grid-rows-12 px-3 py-1 md:px-6 md:py-4 gap-2 max-h-64">
                            ...
                            <Button className="row-span-2 gap-4 mt-8" onClick={() => router.push("https://iotapp.salkaro.com/sign-up")}>
                                Subscribe
                            </Button>
                        </div>
